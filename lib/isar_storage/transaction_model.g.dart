...
void _transactionModelSerialize(
  ...
  writer.writeString(offsets[1], object.paymentId);
...
TransactionModel _transactionModelDeserialize(
  ...
  object.id = id;
  object.paymentId = reader.readString(offsets[1]);
...
extension TransactionModelQueryProperty
  ...
  QueryBuilder<TransactionModel, String, QQueryOperations> paymentIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionModel, String, QQueryOperations> userNameProperty() {
    return QueryBuilder.apply(this, (query) {
...
void _transactionItemSerialize(
  ...
  writer.writeDouble(offsets[0], object.discountedPrice);
...
TransactionItem _transactionItemDeserialize(
  ...
  object.discountedPrice = reader.readDouble(offsets[0]);
