...
class _SignInState extends State<SignIn> {
  ...
  Future<void> _signIn() async {
    ...
    try {
      ...
      User? userCredential = await _auth.signInWithEmailAndPassword(email, password);

      if (userCredential != null) {
        var userDoc = await FirebaseFirestore.instance.collection('Users').doc(userCredential.uid).get();
        ...
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Dashboard(role: role)));
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "Welcome Back!",
                style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xff3e948e)),
              ),
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 30),
                    isloading
                        ? const CircularProgressIndicator(color: Color(0xff3e948e))
                        : SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () => Navigator.pushReplacement(context, SlidingPageTransitionRL(page: SignUp())),
                          child: const Text('Sign Up', style: TextStyle(color: Color(0xff3e948e), fontWeight: FontWeight.bold)),
                        ),
                      ],
                    ),
                  ],
